...
<div class="container mt-4">
    <h2 class="mb-4">Detail Lokasi Petani</h2>
    ...
    <div id="gearth-container" class="d-none mb-3">
        <a id="gearth-link" href="#" target="_blank" class="btn btn-outline-danger">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (lat && lng) {
            ...
            document.getElementById('gearth-link').href = `https://earth.google.com/web/@${lat},${lng},1000a,0d,60y,0h,0t,0r`;
