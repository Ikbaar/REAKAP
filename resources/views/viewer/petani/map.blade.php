...
<div class="container mt-4">
    <h2>Peta Lokasi Petani</h2>

    <div id="osm-map-container" style="height: 500px;" class="mb-3"></div>

    <a href="{{ route('viewer.petani.index') }}" class="btn btn-outline-primary mt-3">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let map = L.map('osm-map-container').setView([-0.7893, 113.9213], 5); // Indonesia default
